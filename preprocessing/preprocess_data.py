import pandas as pd
import numpy as np
from shot_distance import get_shot_type_info, get get_distance_coord
...
def process_fields(arccos_data):
   ...
   arccos_data = get_shot_miss_info(arcos_data)
   arccos_data = get_strokes_gained_info(arcos_data, 'PGA Benchmark.csv', 'PGA Putting Benchmark.csv')
   arccos_data = mapping(arcos_data)
   arccos_data = get_clipped_info(arcos_data, 'data_dictionary.xlsx')
