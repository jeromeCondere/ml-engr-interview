...
def test_distance():
   start_end_pin_angle = calculate_start_end_pin_angle(
      shot_distance=5 , 
      shot_start_distance_yards=7, 
      shot_end_distance_yards=2
   )
...
def test_miss_distance():
   miss_distance1 = calculate_miss_distance(
      miss_bearing_left_right=22, 
      start_end_pin_angle=160, 
      shot_end_distance_yards=7
   )
   assert((round(miss_distance1[0], 4), round(miss_distance1[1], 4)) == (-0.2443, -6.9957))

   miss_distance2 = calculate_miss_distance(
      miss_bearing_left_right=2, 
      start_end_pin_angle=10, 
      shot_end_distance_yards=7
   )
